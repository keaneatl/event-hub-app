using EventHubApp.Client.Pages;
...
builder.Services.AddScoped<IUserTicketsService, UserTicketsService>();
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(EventHubApp.Client._Imports).Assembly);
